...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "w", function () awful.util.spawn( browser1 ) end,
        {description = browser1, group = "MyKeys"}),
    -- dmenu
 ...
 awful.key({ modkey }, "t", function () awful.util.spawn( "qbittorrent" ) end,
        {description = qBittorrent, group = "MyKeys"}),

  awful.key({ modkey, "Ctrl" }, "m",
     function () awful.util.spawn( "strawberry") end,
     {description = Strawberry, group = "MyKeys"}),

  awful.key({ modkey,"Shift" }, "m",
     function () awful.util.spawn( "urxvt -T 'Music Player' -e ncmpcpp") end,
     {description = MP, group = "MyKeys"}),
    ...
    -- super + ... function keys
     awful.key({ modkey, "Shift" }, "e", function () awful.util.spawn( "pamac-manager" ) end,
        {description = PamacGUI, group = "function keys"}),
   
   awful.key({ modkey }, "e", function () awful.util.spawn( "rofi -show emoji -modi emoji" ) end,
        {description = rofiemoji, group = "function keys"}),
   
    -- super + ... function keys
     awful.key({ modkey }, "F12", function () awful.util.spawn( "wal -i /media/MEDIA/WP/Downloaded/nasa_apod" ) end,
        {description = Wallpaper, group = "function keys"}),
    
    awful.key({ modkey }, "F1", function () awful.util.spawn( "telegram-desktop" ) end,
        {description = Telegram, group = "function keys"}),
    awful.key({ modkey }, "F2", function () awful.util.spawn( "element-desktop" ) end,
        {description = "Element" , group = "function keys" }),
    awful.key({ modkey }, "F3", function () awful.util.spawn( "nicotine" ) end,
        {description = "Nicotine" ,group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "libreoffice --writer" ) end,
        {description = "LibreOffice Writer" , group = "function keys" }),
    awful.key({ modkey }, "F5", function () awful.util.spawn( "whatsapp-nativefier-dark" ) end,
        {description = "Whatsapp" , group = "function keys" }),
    --awful.key({ modkey }, "F6", function () awful.util.spawn( "vlc --video-on-top" ) end,
      --  {description = "vlc" , group = "function keys" }),
     awful.key({ modkey }, "F7", function () awful.util.spawn( "urxvt -T 'IRC' -e weechat" ) end,
        {description = IRC , group = "function keys" }),
    awful.key({ modkey }, "F6", function () awful.util.spawn( "urxvt -T 'Matrix' -e gomuks" ) end,
        {description = Matrix , group = "function keys" }),
    awful.key({ modkey }, "f", function () awful.util.spawn( filemanager ) end,
        {description = filemanager , group = "function keys" }),
    awful.key({ modkey }, "F9", function () awful.util.spawn( "mailspring" ) end,
...
awful.key({ modkey, "Shift" }, "F9", function () awful.util.spawn( "urxvt -T 'Mail' -e neomutt" ) end,
        {description = mailclient , group = "function keys" }),
    ...
    awful.key({ modkey }, "F8", function () awful.util.spawn( "urxvt -T 'htop task manager' -e htop" ) end,
        {description = "htop", group = "super"}),
    awful.key({ modkey, "Control" }, "r", function () awful.util.spawn( "rofi-theme-selector" ) end,
   ...
   -- awful.key({ modkey }, "t", function () awful.util.spawn( terminal ) end,
    ...
    awful.key({ modkey, "Shift"   }, "i", function() awful.util.spawn( "urxvt -T 'IRC' -e weechat" ) end),
    ...
    awful.key({ modkey1, altkey   }, "f", function() awful.util.spawn( "urxvt -T 'ranger' -e  ranger" ) end,
        {description = ranger, group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey   }, "t", function() awful.util.spawn( "kitty" ) end,
    ...
    awful.key({ modkey, "Shift" }, "n", function () awful.util.spawn("urxvt -T RSS -e newsboat -r") end,
              {description = "Newsboat", group = "tag"}),

    --awful.key({ modkey, "Shift" }, "m", function () awful.util.spawn("urxvt -T RSS -e mp") end,
      --        {description = "MP", group = "tag"}),
...
awful.key({}, "XF86TouchpadToggle", function() awful.util.spawn("synclient | grep 'TouchpadOff.*1' && synclient TouchpadOff=0) || synclient TouchpadOff=1") end,{description = "sdsad", group = "hotkeys"}),
...
awful.spawn.with_shell("xrandr --output VGA-1 --primary --mode 1440x900 --pos 240x1080 --rotate normal --output DVI-D-1 --off --output DVI-D-2 --off --output HDMI-1 --mode 1920x1080 --pos 0x0 --rotate normal")
